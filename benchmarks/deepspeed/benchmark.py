"""Run all deepspeed paper sizes: fair table, then feat table."""
...
def main() -> int:
    ...
    for profile in ("fair", "feat"):
        print(f"\n======== DEEPSPEED PROFILE={profile} ========", flush=True)
    ...
    print(f"\n======== DEEPSPEED DONE failures={failures} ========", flush=True)
