...
void CudaCausalSelfAttention::forward(const CudaMatrix& input, CudaMatrix& out) {
    ...
    CudaOps::rotaryRotateInPlace(this->query, this->headCount, this->headDimension, this->pairCount, this->cosTable, this->sinTable);
    CudaOps::rotaryRotateInPlace(this->key, this->headCount, this->headDimension, this->pairCount, this->cosTable, this->sinTable);
